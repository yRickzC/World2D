  ...
  },
  {
    ...
    properties: {
      ...
      secondaryColor: {
        ...
        required: false,
        default: '#475569',
        description: 'Cor complementar para sombreamento ou padrões.',
      },
      pattern: {
        label: 'Padrão Visual',
        type: 'string',
        required: false,
        default: 'plain',
        allowedValues: ['plain', 'blades', 'checker', 'wave', 'speckle', 'stone_cobble', 'wood_planks', 'dirt_depth', 'dug_pit'],
        description: 'Padrão gráfico aplicado na renderização do bloco.',
      },
    },
  },
  {
    ...
    version: '1.0.0',
    description: 'Define textura e acabamento específicos para a face superior do bloco.',
    isDynamic: false,
    isSingleton: true,
    properties: {
      primaryColor: {
        ...
        required: true,
        default: '#4ade80',
        description: 'Cor da superfície superior vista de cima.',
      },
      pattern: {
        label: 'Padrão Superior',
        type: 'string',
        required: false,
        default: 'plain',
        allowedValues: ['plain', 'blades', 'checker', 'wave', 'speckle', 'stone_cobble', 'wood_planks', 'dug_pit'],
        description: 'Padrão da face superior do bloco.',
      },
    },
  },
  {
    ...
    version: '1.0.0',
    description: 'Define relevo e face lateral do bloco (para paredes e desníveis).',
    isDynamic: false,
    isSingleton: true,
    properties: {
      primaryColor: {
        ...
        required: true,
        default: '#5c3a21',
        description: 'Cor principal da face lateral.',
      },
      defaultWallHeight: {
        label: 'Altura Lateral da Parede',
        type: 'number',
        required: false,
        default: 12,
        min: 0,
        max: 32,
        description: 'Altura em pixels da face lateral projetada.',
      },
    },
  },
  {
    ...
    version: '1.0.0',
    description: 'Ícone simbólico emoji representativo do bloco na interface e fallback.',
    isDynamic: false,
    isSingleton: true,
    properties: {
      emoji: {
        ...
        required: true,
        default: '🪨',
        description: 'Caractere Unicode / Emoji representativo do bloco.',
      },
    },
  },
  {
